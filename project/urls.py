...
urlpatterns = [
    ...
    path('post/<slug:title>', blog_views.view_post, name='view_post'),
    path('draft/<slug:title>', blog_views.view_draft, name='view_draft'),
    ...
    path('blog/posts/<slug:title>/', blog_views.view_post, name='view_blog_post'),
    ...
    path('articles/posts/<slug:title>/', blog_views.view_post, name='view_article_post'),
    
    path('', blog_views.home, name='home'),
    path('about', blog_views.about, name='about'),
    path('contact', blog_views.contact, name='contact'),
    path('site/<slug:title>/', blog_views.permanent, name='permanent_page'),
